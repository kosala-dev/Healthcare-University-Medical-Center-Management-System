...
export default function Home({ role, userId }) {
  ...
  return (
    <>
      <div className="w-full h-fit bg-gradient-to-r from-blue-50 to-purple-50">
        <Navbar role={role} userId={userId}></Navbar>
      </div> <br/>

      <div className="w-full flex flex-col sm:flex-row items-center px-5 sm:px-10 py-8 bg-gradient-to-r from-[#4A0033] via-[#670047] to-[#9A006C]">
        <img
