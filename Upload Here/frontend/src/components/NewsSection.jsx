  ...
  return (
    <section className="bg-gray-50 py-12 px-6 md:px-12 lg:px-20">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="relative w-full max-w-3xl h-[450px] mx-auto overflow-hidden rounded-2xl mb-10 flex justify-center items-center bg-gray-100">
            <div
            ...
            onClick={async () => {
              try {
                ...
                if (res.ok && data.login) {
                  // Token is valid → allow form submission
