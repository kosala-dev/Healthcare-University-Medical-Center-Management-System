...
export default function DeanDashboard({ username, faculty }) {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-r from-blue-50 to-purple-50">
      ...
      <div className="w-3/4 p-8">
        ...
        <div className="bg-white rounded-lg shadow-md hover:scale-105 transition cursor-pointer" onClick={goDeanApproval}>
          ...
          <div className="p-6">
            ...
            <p className="text-gray-500 mt-2">Review student forms approved by HOD</p>
          </div>
        </div>
      </div>
    </div>
