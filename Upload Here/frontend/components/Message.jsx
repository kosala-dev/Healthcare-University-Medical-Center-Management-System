...
export default function Message() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#E8E8E8] flex flex-col items-center py-10 px-4 sm:px-8 lg:px-20">
      
      <div className="self-start mb-6">
        <button
          onClick={() => navigate(-1)}
          className="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg shadow hover:bg-gray-300 transition-all"
        >
          ← Back
        </button>
      </div>
      ...
      <div className="w-full max-w-3xl bg-white shadow-xl rounded-3xl py-10 px-6 sm:px-10 lg:px-16">
        <form onSubmit={handlesubmit}>
          ...
          <div className="mb-6">
            ...
            <textarea
              className="w-full h-40 bg-zinc-100 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500"
              rows={8}
              value={message}
