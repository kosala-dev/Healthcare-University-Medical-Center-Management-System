...
export default function RegisterStudent() {
  ...
  const [image, setImage] = useState(""); // image path string
  ...
  const handleGenderChange = (e) => {
    ...
    if (selectedGender === "Male") {
      setImage("/default_male.png"); // place in public folder
    } else if (selectedGender === "Female") {
      setImage("/default_female.png"); // place in public folder
    } else {
      setImage(""); // optional for Other
    }
  };
    ...
    try {
      ...
      const res = await axios.post(
        "http://localhost:8080/patient/patientregister",
        {
          ...
          gender,
          password,
          image, // automatically set based on gender
        }
      );
