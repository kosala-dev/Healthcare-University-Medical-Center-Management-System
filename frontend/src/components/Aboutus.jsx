          ...
          <div className="w-full lg:w-1/2 bg-white rounded-xl shadow-lg p-6 md:p-8 hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center gap-4">
              <button
                ...
                className="px-6 py-3 bg-[#670047] text-white font-medium rounded-lg shadow-md hover:bg-[#670050]  transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-opacity-50 flex items-center gap-2"
              >
                {expanded ? (
                  <>
                    <span>Show Less</span>
