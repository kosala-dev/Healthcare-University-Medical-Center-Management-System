...
export default function MedicalFormsHod() {
  ...
  // HOD sees only forms approved by Advisor
  const fetchForms = async () => {
    setLoading(true);
    try {
      // Backend filter: returns forms where advisorApproval.status === "Approved" 
      // AND hodApproval.status === "Pending"
      const res = await axios.get(`http://localhost:8080/api/approvalForms/hod/${faculty}/${department}`);
  ...
  const handleApproval = async (formId, action) => {
    try {
      ...
      // Update UI: remove the form from the HOD's list after action
        ...
        <div className="w-full md:w-5/6 lg:w-3/4 max-w-6xl">
          ...
          <div className="mb-6 md:mb-8 flex flex-col md:flex-row justify-between items-end md:items-center gap-4">
            <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Reviewing forms pre-verified by Doctor and Advisor</p>
          ...
          {loading ? (
            ...
            <div className="bg-white p-12 rounded-xl shadow-sm border border-gray-100 text-center">
                {searchTerm ? (
                   ...
                   <p className="text-gray-500 text-lg">No forms pending your approval.</p>
                )}
            </div>
          ) : (
                ...
                >
                  <div className="bg-blue-50 p-4 border-b border-blue-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 font-medium">{f.registrationNo}</p>
                    </div>
                  ...
                  <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col justify-between border-t lg:border-t-0 lg:border-l border-gray-100 pt-6 lg:pt-0 lg:pl-6">
                      ...
                      <div className="mb-6">
                         <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 text-center">Current Status Flow</h4>
                      ...
                      <div className="space-y-3 mt-auto">
                        <p className="text-xs text-center text-gray-400 mb-2 font-bold uppercase">Take Action as HOD</p>
                        <button
