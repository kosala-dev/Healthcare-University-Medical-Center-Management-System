...
export default function MedicalFormsHod() {
  ...
  const fetchForms = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`http://localhost:8080/api/approvalForms/hod/any/any`);
      console.log("HOD forms raw:", res.data.forms);
                  ...
                  <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col justify-between border-t lg:border-t-0 lg:border-l border-gray-100 pt-6 lg:pt-0 lg:pl-6">
                      ...
                      <div className="space-y-3 mt-auto">
                        <p className="text-xs text-center text-gray-400 mb-2">Take Action as HOD</p>
                        <button
