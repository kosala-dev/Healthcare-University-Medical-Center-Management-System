...
export default function MedicalForm() {
  ...
  const opt = {
    margin: 0.5,
    filename: "OnlineMedicalForm.pdf",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-10 px-4">
        <div id="pdf-content" ref = {printRef} className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
          <h1 className="text-2xl  mb-4 text-center">University Of Vavuniya</h1>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              {/* Office Use Only */}
              <h3 className="mt-4 font-medium">FOR OFFICE USE ONLY</h3>
