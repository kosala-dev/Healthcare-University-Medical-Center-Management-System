...
export default function Admindashboard({ username, gender, createdAt, admintype }) {
  ...
  // Fetch admin details
  useEffect(() => {
      axios.get(`http://localhost:8080/auth/admindetails`, {
        params: { username, gender, createdAt, admintype }
      })
      .then((response) => {
  ...
  // Fetch notifications periodically (real-time updates)
  useEffect(() => {
  ...
  // Filter only low-stock notifications
        ...
        <div>
          ...
          <div className="mt-8 text-white">
            ...
            <p className="text-lg font-medium mt-2">
              Type: <span className="font-bold">{admintype}</span>
            </p>
            <p className="text-lg font-medium mt-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Click Here to See All Patient Prescription / Diagnosis
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Click Here to View Submitted Medical Forms
              </p>
            </div>
          </div>
