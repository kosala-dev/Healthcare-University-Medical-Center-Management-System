...
return (
  <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-r from-blue-50 to-purple-50">
    ...
    {/* Sidebar */}
    <div className="w-full md:w-1/4 bg-gradient-to-r from-[#4A0033] via-[#670047] to-[#9A006C] p-4 md:p-8 flex flex-col justify-between">
      ...
      <button
        onClick={handleClick}
        className="w-full mt-6 md:mt-0 bg-white text-blue-600 py-2 px-4 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
      >
        Back to Dashboard
      </button>
    </div>
    ...
    <div className="w-full md:w-3/4 p-4 md:p-8">
      ...
      <div className="bg-white p-4 md:p-6 rounded-lg shadow-md">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white p-3 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 transition-all disabled:opacity-50"
            disabled={loading}
          >
