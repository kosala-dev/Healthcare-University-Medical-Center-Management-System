  ...
  <nav className="w-full bg-[#670047] text-white px-4 md:px-20">
    ...
    <div className="flex items-center justify-between h-14">
      ...
      <div className="hidden md:flex items-center">
        {role === "superadmin" && (
          <>
            <Button onClick={SuperGoAdmindDshboard} className="mr-3 border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Super Admin Dashboard
            </Button>
            <Button onClick={GoLogOut} className="border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Logout
            </Button>
          </>
        )}
        ...
        {role === "patient" && (
          <>
            <Button onClick={GopatientDashboard} className="mr-3 border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Dashboard
            </Button>
            <Button onClick={GoLogOut} className="border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Logout
        ...
        {role === "admin" && (
          <>
            <Button onClick={Gototadmindashboard} className="mr-3 border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Admin Dashboard
            </Button>
            <Button onClick={GoLogOut} className="border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Logout
        ...
        {role === "hod" && (
          <>
            <Button onClick={Gotohoddashboard} className="mr-3 border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Admin Dashboard
            </Button>
            <Button onClick={GoLogOut} className="border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Logout
        ...
        {role === "dean" && (
          <>
            <Button onClick={Gotodeandashboard} className="mr-3 border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Admin Dashboard
            </Button>
            <Button onClick={GoLogOut} className="border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Logout
        ...
        {role === "advisor" && (
          <>
            <Button onClick={Gotoadvisordashboard} className="mr-3 border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Admin Dashboard
            </Button>
            <Button onClick={GoLogOut} className="border-2 border-[#ffcb00] bg-[#670047] hover:bg-[#670047]">
              Logout
