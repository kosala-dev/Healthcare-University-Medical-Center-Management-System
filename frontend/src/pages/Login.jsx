...
export default function Login({ setRole2 }) {
      ...
      .then((res) => {
        if (res.data.login && res.data.role) {
          ...
          if (res.data.role === "superadmin") {
            ...
            navigate("/admindashboard", { state: { username: res.data.username, gender: res.data.gender } });
          }else if (res.data.role === "advisor") {
            navigate("/advisordashboard", { state: { username: res.data.username, gender: res.data.gender } });
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-indigo-50 to-purple-50 min-h-screen py-12 relative">
        <div className="w-full max-w-md p-8 bg-white shadow-lg rounded-lg">
          ...
          <button
            className="w-full py-2 px-4 bg-[#670047] text-white font-semibold rounded-md hover:bg-[#670050] transition duration-200"
          ...
          <div className="flex flex-col items-center mt-4">
            <button
              ...
              className="block mt-4 text-center text-black-600 hover:text-blue-800 underline"
            >
              Forget Password
            </button> 
          </div>
